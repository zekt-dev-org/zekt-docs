...
Single infrastructure provider - Azure as of now! We are using PaaS services to layer / package our SaaS offering. For greater details of principals around infrastructure & system design concerns, please visist [this article](/zekt-docs/architecture/system-architecture/)!
